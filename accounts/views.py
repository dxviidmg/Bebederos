...
class ListViewEscuelas(View):
	...
	def get(self, request, pk=None):
		...
		escuelas = User.objects.filter(perfil__in=perfiles).order_by('perfil__numero', 'perfil__localidad', 'perfil__nivel_educativo')
...
class ListViewAvanceEscuelas(View):
	...
	def get(self, request, slug):
		...
		escuelas = User.objects.filter(perfil__in=perfilesEscuelas).order_by('perfil__numero', 'perfil__municipio__nombre', 'perfil__localidad', 'perfil__nivel_educativo')
