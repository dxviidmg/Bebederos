...
def ExportAvancePorEscuelasCSV(request, pk):
	...
	writer.writerow(['Zona', 'Número', 'Municipio', 'Localidad', 'Domicilio', 'C. C. T.','Nombre', 'Nivel educativo', 'Plantilla escolar', 'Mueble', 'Sistema potabilizador', 'Fecha de primer muestreo', 'Resultados de laboratorio de primer prueba', 'Validación de primer prueba', 'Acta de ubicación', 'Cedula de identificación','Convenio de concertación', 'Constancia de integración de comité', 'Plano de conjunto', 'Distribución en planta', 'Memoria de cálculo hidráulico', 'Memoria de cálculo sanitario', 'Memoria de cálculo electrico', 'Isométricos', 'Acta de inicio de construcción', 'Número de evidencias subidas', 'Ultima foto de evidencia subida', 'Porcentaje de construcción', 'Salida de mueble', 'Fecha de segundo muestreo', 'Resultados de laboratorio de segunda prueba', 'Validación de segunda prueba', 'Acta de inicio de funcionamiento', 'Foto de inicio de funcionamiento', 'Mantenimientos', 'Acta de entrega', 'Director', 'Teléfono', 'Realización de Expediente técnico', 'PRDC'])

	escuelas = User.objects.filter(perfil__in=perfiles).values_list('perfil__municipio__zona__nombre', 'perfil__numero', 'perfil__municipio__nombre', 'perfil__localidad', 'perfil__domicilio', 'username', 'first_name', 'perfil__nivel_educativo', 'perfil__plantilla_escolar', 'escuela__mueble__modelo', 'escuela__sistema_potabilizacion__tipo', 'escuela_primer_prueba__creacion','escuela_primer_prueba__resultados_laboratorio', 'escuela_primer_prueba__validacion', 'escuela_visita_acuerdo__acta_ubicacion', 'escuela_visita_acuerdo__cedula_identificacion', 'escuela_visita_acuerdo__convenio_concertacion', 'escuela_visita_acuerdo__constancia_integracion_comite', 'escuela_visita_acuerdo__plano_conjunto', 'escuela_visita_acuerdo__distribucion_planta', 'escuela_visita_acuerdo__memoria_calculo_1', 'escuela_visita_acuerdo__memoria_calculo_2', 'escuela_visita_acuerdo__memoria_calculo_3', 'escuela_visita_acuerdo__isometrico_instalacion', 'escuela_inicio_trabajo__acta_inicio', 'perfil__evidencias', 'perfil__nombre_ultima_evidencia', 'perfil__avance', 'escuela__packing_list', 'escuela_segunda_prueba__creacion', 'escuela_segunda_prueba__resultados_laboratorio', 'escuela_segunda_prueba__validacion', 'escuela_inicio_funcionamiento__acta_funcionamiento', 'escuela_inicio_funcionamiento__foto', 'perfil__mantenimientos', 'escuela_acta_entrega__creacion', 'perfil__director', 'perfil__telefono', 'perfil__expediente_tecnico', 'perfil__prioridad')
	for escuela in escuelas:
