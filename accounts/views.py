...
def ExportAvancePorEscuelasCSV(request, pk):
	...
	writer.writerow(['Zona', 'Municipio', 'Localidad', 'Domicilio', 'C. C. T.','Nombre del plantel', 'Nivel educativo', 'Plantilla', 'Mueble', 'Sistema potabilizador', 'Fecha de muestro', 'Validación de primer prueba', 'Acta de ubicación', 'Cedula de identificación','Convenio de concertación', 'Constancia de integración de comité', 'plano de conjunto', 'distribucion en planta', 'Memoria de cálculo hidráulico', 'Memoria de cálculo sanitario', 'Memoria de cálculo electrico', 'Isométricos', 'Acta de inicio de trabajo', 'Porcentaje de construcción', 'Validación de sistema potabilizador', 'Inicio de funcionamiento', 'Mantenimientos', 'Acta de entrega', 'Director', 'Teléfono'])

	escuelas = User.objects.filter(perfil__in=perfiles).values_list('perfil__municipio__zona__nombre', 'perfil__municipio__nombre', 'perfil__localidad', 'perfil__domicilio', 'username', 'first_name', 'perfil__nivel_educativo', 'perfil__plantilla_escolar', 'escuela__mueble__modelo', 'escuela__sistema_potabilizacion__tipo', 'escuela_primer_prueba__creacion', 'escuela_primer_prueba__validacion', 'escuela_visita_acuerdo__acta_ubicacion', 'escuela_visita_acuerdo__cedula_identificacion', 'escuela_visita_acuerdo__convenio_concertacion', 'escuela_visita_acuerdo__constancia_integracion_comite', 'escuela_visita_acuerdo__plano_conjunto', 'escuela_visita_acuerdo__distribucion_planta', 'escuela_visita_acuerdo__memoria_calculo_1', 'escuela_visita_acuerdo__memoria_calculo_2', 'escuela_visita_acuerdo__memoria_calculo_3', 'escuela_visita_acuerdo__isometrico_instalacion', 'escuela_inicio_trabajo__acta_inicio', 'perfil__avance', 'escuela_segunda_prueba__validacion', 'escuela_inicio_funcionamiento__creacion', 'perfil__mantenimientos', 'escuela_acta_entrega__creacion', 'perfil__director', 'perfil__telefono')
	for escuela in escuelas:
