...
class VisitaDeAcuerdoCreateForm(forms.ModelForm):
	class Meta:
		...
		fields = ('cedula_identificacion', 'convenio_concertacion', 'croquis_modulo', 'constancia_integracion_comite', 'plano_conjunto', 'distribucion_planta', 'memoria_calculo', 'plano_instalacion_electrica', 'plano_instalacion_hidraulica', 'plano_instalacion_sanitaria')
		#fields = ()
