...
def ExportComprobanteTrazabilidadPDF(request, pk):
	...
	nombre1 = "Ing. Raúl A. Mejía Mejía"
	t16 = Paragraph(nombre1, styleText3)
	Story.append(t16)

	puesto1 = "Coordinador de Taller"
	t17 = Paragraph(puesto1, styleText3)
	Story.append(t17)

	linea2 = "__________________________"
	...
	linea3 = "__________________________"
...
def ExportAvanceBebederosCSV(request, pk):
	...
	writer.writerow(['Numero', 'Municipio', 'C. C. T.','Nombre del plantel', 'Nivel educativo', 'Mueble', 'Sistema potabilizador', 'Validación de primer prueba', 'Guia de trazabilidad', 'Packing list (Mueble entregado)'])

	escuelas = User.objects.filter(perfil__in=perfiles).values_list('perfil__numero', 'perfil__municipio__nombre', 'username', 'first_name', 'perfil__nivel_educativo', 'escuela__mueble__modelo', 'escuela__sistema_potabilizacion__tipo', 'escuela_primer_prueba__validacion', 'escuela__no_trazabilidad', 'escuela__packing_list')
